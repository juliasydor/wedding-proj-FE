...
import { Heart, Calendar, MapPin, Leaf, Gift, Mail, Hotel, Camera, Clock, Users, ChevronDown, ExternalLink, Shirt } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {dressCode.guests?.enabled && (
                <div className="bg-white rounded-2xl p-6 text-center shadow-sm border" style={{ borderColor: `${primaryColor}30` }}>

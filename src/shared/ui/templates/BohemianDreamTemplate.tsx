...
import { Heart, MapPin, Sparkles, Sun, Moon, Gift, Mail, Hotel, Camera, Clock, Users, ChevronDown, ExternalLink, Plane, Shirt } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {dressCode.guests?.enabled && (
                <div className="bg-[#fef9f3] rounded-3xl p-6 text-center shadow-sm">
